...
namespace AutoMerge
{
    public class BranchValidator
    {
        ...
        private static bool IsMerged(string sourcePath, string targetPath, IEnumerable<ExtendedMerge> trackMerges)
        {
            ...
            return trackMerges.Any(m => (m.TargetItem.Item.Equals(sourcePath, StringComparison.OrdinalIgnoreCase)
                    && m.SourceItem.Item.ServerItem.Equals(targetPath, StringComparison.OrdinalIgnoreCase))
                || (m.TargetItem.Item.Equals(targetPath, StringComparison.OrdinalIgnoreCase)
                    && m.SourceItem.Item.ServerItem.Equals(sourcePath, StringComparison.OrdinalIgnoreCase)));
        }
